...
var questions = [
  {
    ...
    choices: ["alertBox(“Hello DataFlair!”);", "msgAlert(“Hello DataFlair!”);", "alert(“Hello DataFlair!”);"],
  ...
  },
  {
    ...
    choices: ["JavaScript can manipulate cookies using the cookie property of the Document object.", "JavaScript can read, create, modify, and delete the cookie or cookies that apply to the current web page.", "Both of the above.", "None of the above."],
...
function init() {
  questionEl.textContent = `Test your Javascript knowlege with the following quiz. Click "Start Quiz" to get started.`
